...
module soc_system_mm_interconnect_1 (
		...
		output wire [4:0]  miner_0_avalon_slave_address,                  //                    miner_0_avalon_slave.address
		output wire        miner_0_avalon_slave_write,                    //                                        .write
		output wire        miner_0_avalon_slave_read,                     //                                        .read
		input  wire [31:0] miner_0_avalon_slave_readdata,                 //                                        .readdata
		output wire [31:0] miner_0_avalon_slave_writedata                 //                                        .writedata
	);
	...
	wire  [31:0] miner_0_avalon_slave_agent_m0_readdata;                            // miner_0_avalon_slave_translator:uav_readdata -> miner_0_avalon_slave_agent:m0_readdata
	wire         miner_0_avalon_slave_agent_m0_waitrequest;                         // miner_0_avalon_slave_translator:uav_waitrequest -> miner_0_avalon_slave_agent:m0_waitrequest
	wire         miner_0_avalon_slave_agent_m0_debugaccess;                         // miner_0_avalon_slave_agent:m0_debugaccess -> miner_0_avalon_slave_translator:uav_debugaccess
	wire  [14:0] miner_0_avalon_slave_agent_m0_address;                             // miner_0_avalon_slave_agent:m0_address -> miner_0_avalon_slave_translator:uav_address
	wire   [3:0] miner_0_avalon_slave_agent_m0_byteenable;                          // miner_0_avalon_slave_agent:m0_byteenable -> miner_0_avalon_slave_translator:uav_byteenable
	wire         miner_0_avalon_slave_agent_m0_read;                                // miner_0_avalon_slave_agent:m0_read -> miner_0_avalon_slave_translator:uav_read
	wire         miner_0_avalon_slave_agent_m0_readdatavalid;                       // miner_0_avalon_slave_translator:uav_readdatavalid -> miner_0_avalon_slave_agent:m0_readdatavalid
	wire         miner_0_avalon_slave_agent_m0_lock;                                // miner_0_avalon_slave_agent:m0_lock -> miner_0_avalon_slave_translator:uav_lock
	wire  [31:0] miner_0_avalon_slave_agent_m0_writedata;                           // miner_0_avalon_slave_agent:m0_writedata -> miner_0_avalon_slave_translator:uav_writedata
	wire         miner_0_avalon_slave_agent_m0_write;                               // miner_0_avalon_slave_agent:m0_write -> miner_0_avalon_slave_translator:uav_write
	wire   [2:0] miner_0_avalon_slave_agent_m0_burstcount;                          // miner_0_avalon_slave_agent:m0_burstcount -> miner_0_avalon_slave_translator:uav_burstcount
	wire         miner_0_avalon_slave_agent_rf_source_valid;                        // miner_0_avalon_slave_agent:rf_source_valid -> miner_0_avalon_slave_agent_rsp_fifo:in_valid
	wire  [87:0] miner_0_avalon_slave_agent_rf_source_data;                         // miner_0_avalon_slave_agent:rf_source_data -> miner_0_avalon_slave_agent_rsp_fifo:in_data
	wire         miner_0_avalon_slave_agent_rf_source_ready;                        // miner_0_avalon_slave_agent_rsp_fifo:in_ready -> miner_0_avalon_slave_agent:rf_source_ready
	wire         miner_0_avalon_slave_agent_rf_source_startofpacket;                // miner_0_avalon_slave_agent:rf_source_startofpacket -> miner_0_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire         miner_0_avalon_slave_agent_rf_source_endofpacket;                  // miner_0_avalon_slave_agent:rf_source_endofpacket -> miner_0_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire         miner_0_avalon_slave_agent_rsp_fifo_out_valid;                     // miner_0_avalon_slave_agent_rsp_fifo:out_valid -> miner_0_avalon_slave_agent:rf_sink_valid
	wire  [87:0] miner_0_avalon_slave_agent_rsp_fifo_out_data;                      // miner_0_avalon_slave_agent_rsp_fifo:out_data -> miner_0_avalon_slave_agent:rf_sink_data
	wire         miner_0_avalon_slave_agent_rsp_fifo_out_ready;                     // miner_0_avalon_slave_agent:rf_sink_ready -> miner_0_avalon_slave_agent_rsp_fifo:out_ready
	wire         miner_0_avalon_slave_agent_rsp_fifo_out_startofpacket;             // miner_0_avalon_slave_agent_rsp_fifo:out_startofpacket -> miner_0_avalon_slave_agent:rf_sink_startofpacket
	wire         miner_0_avalon_slave_agent_rsp_fifo_out_endofpacket;               // miner_0_avalon_slave_agent_rsp_fifo:out_endofpacket -> miner_0_avalon_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_src_valid;                                                 // cmd_mux:src_valid -> miner_0_avalon_slave_agent:cp_valid
	wire  [86:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> miner_0_avalon_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                 // miner_0_avalon_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                               // cmd_mux:src_channel -> miner_0_avalon_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                         // cmd_mux:src_startofpacket -> miner_0_avalon_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                           // cmd_mux:src_endofpacket -> miner_0_avalon_slave_agent:cp_endofpacket
	...
	wire  [87:0] led_pio_s1_agent_rf_source_data;                                   // led_pio_s1_agent:rf_source_data -> led_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] led_pio_s1_agent_rsp_fifo_out_data;                                // led_pio_s1_agent_rsp_fifo:out_data -> led_pio_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [14:0] dipsw_pio_s1_agent_m0_address;                                     // dipsw_pio_s1_agent:m0_address -> dipsw_pio_s1_translator:uav_address
	...
	wire  [87:0] dipsw_pio_s1_agent_rf_source_data;                                 // dipsw_pio_s1_agent:rf_source_data -> dipsw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] dipsw_pio_s1_agent_rsp_fifo_out_data;                              // dipsw_pio_s1_agent_rsp_fifo:out_data -> dipsw_pio_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> dipsw_pio_s1_agent:cp_data
	...
	wire  [14:0] button_pio_s1_agent_m0_address;                                    // button_pio_s1_agent:m0_address -> button_pio_s1_translator:uav_address
	...
	wire  [87:0] button_pio_s1_agent_rf_source_data;                                // button_pio_s1_agent:rf_source_data -> button_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] button_pio_s1_agent_rsp_fifo_out_data;                             // button_pio_s1_agent_rsp_fifo:out_data -> button_pio_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [86:0] mm_bridge_0_m0_agent_cp_data;                                      // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire         miner_0_avalon_slave_agent_rp_valid;                               // miner_0_avalon_slave_agent:rp_valid -> router_001:sink_valid
	wire  [86:0] miner_0_avalon_slave_agent_rp_data;                                // miner_0_avalon_slave_agent:rp_data -> router_001:sink_data
	wire         miner_0_avalon_slave_agent_rp_ready;                               // router_001:sink_ready -> miner_0_avalon_slave_agent:rp_ready
	wire         miner_0_avalon_slave_agent_rp_startofpacket;                       // miner_0_avalon_slave_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         miner_0_avalon_slave_agent_rp_endofpacket;                         // miner_0_avalon_slave_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [86:0] led_pio_s1_agent_rp_data;                                          // led_pio_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [86:0] dipsw_pio_s1_agent_rp_data;                                        // dipsw_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [86:0] button_pio_s1_agent_rp_data;                                       // button_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [86:0] router_src_data;                                                   // router:src_data -> mm_bridge_0_m0_limiter:cmd_sink_data
	...
	wire  [86:0] mm_bridge_0_m0_limiter_cmd_src_data;                               // mm_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [86:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [86:0] mm_bridge_0_m0_limiter_rsp_src_data;                               // mm_bridge_0_m0_limiter:rsp_src_data -> mm_bridge_0_m0_agent:rp_data
	...
	wire         miner_0_avalon_slave_agent_rdata_fifo_src_valid;                   // miner_0_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] miner_0_avalon_slave_agent_rdata_fifo_src_data;                    // miner_0_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         miner_0_avalon_slave_agent_rdata_fifo_src_ready;                   // avalon_st_adapter:in_0_ready -> miner_0_avalon_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                     // avalon_st_adapter:out_0_valid -> miner_0_avalon_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                      // avalon_st_adapter:out_0_data -> miner_0_avalon_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                     // miner_0_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                     // avalon_st_adapter:out_0_error -> miner_0_avalon_slave_agent:rdata_fifo_sink_error
	wire         led_pio_s1_agent_rdata_fifo_src_valid;                             // led_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] led_pio_s1_agent_rdata_fifo_src_data;                              // led_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         led_pio_s1_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_001:in_0_ready -> led_pio_s1_agent:rdata_fifo_src_ready
	...
	wire         dipsw_pio_s1_agent_rdata_fifo_src_valid;                           // dipsw_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] dipsw_pio_s1_agent_rdata_fifo_src_data;                            // dipsw_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         dipsw_pio_s1_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_002:in_0_ready -> dipsw_pio_s1_agent:rdata_fifo_src_ready
	...
	) miner_0_avalon_slave_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (miner_0_avalon_slave_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (miner_0_avalon_slave_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (miner_0_avalon_slave_agent_m0_read),            //                         .read
		.uav_write              (miner_0_avalon_slave_agent_m0_write),           //                         .write
		.uav_waitrequest        (miner_0_avalon_slave_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (miner_0_avalon_slave_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (miner_0_avalon_slave_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (miner_0_avalon_slave_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (miner_0_avalon_slave_agent_m0_writedata),       //                         .writedata
		.uav_lock               (miner_0_avalon_slave_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (miner_0_avalon_slave_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (miner_0_avalon_slave_address),                  //      avalon_anti_slave_0.address
		.av_write               (miner_0_avalon_slave_write),                    //                         .write
		.av_read                (miner_0_avalon_slave_read),                     //                         .read
		.av_readdata            (miner_0_avalon_slave_readdata),                 //                         .readdata
		.av_writedata           (miner_0_avalon_slave_writedata),                //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) miner_0_avalon_slave_agent (
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (miner_0_avalon_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (miner_0_avalon_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (miner_0_avalon_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (miner_0_avalon_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (miner_0_avalon_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (miner_0_avalon_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (miner_0_avalon_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (miner_0_avalon_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (miner_0_avalon_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (miner_0_avalon_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (miner_0_avalon_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (miner_0_avalon_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (miner_0_avalon_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (miner_0_avalon_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (miner_0_avalon_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (miner_0_avalon_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (miner_0_avalon_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (miner_0_avalon_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (miner_0_avalon_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (miner_0_avalon_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (miner_0_avalon_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (miner_0_avalon_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (miner_0_avalon_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (miner_0_avalon_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (miner_0_avalon_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (miner_0_avalon_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (miner_0_avalon_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (miner_0_avalon_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (miner_0_avalon_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) miner_0_avalon_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                         //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (miner_0_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (miner_0_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (miner_0_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (miner_0_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (miner_0_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (miner_0_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (miner_0_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (miner_0_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (miner_0_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (miner_0_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	soc_system_mm_interconnect_1_router_001 router_001 (
		.sink_ready         (miner_0_avalon_slave_agent_rp_ready),           //      sink.ready
		.sink_valid         (miner_0_avalon_slave_agent_rp_valid),           //          .valid
		.sink_data          (miner_0_avalon_slave_agent_rp_data),            //          .data
		.sink_startofpacket (miner_0_avalon_slave_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (miner_0_avalon_slave_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (miner_0_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (miner_0_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (miner_0_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
